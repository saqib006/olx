...
import {TableCell, TableRow, IconButton, Grid, Typography, ExpansionPanelDetails ,ExpansionPanel, ExpansionPanelSummary, Hidden, Divider} from '@material-ui/core';
import DeleteForever from '@material-ui/icons/DeleteForever';
import ExpandMoreIcon from '@material-ui/icons/ExpandMore';
class SaveAds extends Component{
    constructor(props){
        super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(SaveAds);